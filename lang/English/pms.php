...
// Common
'Login required'		=>	'You must be logged in to use the messages system',
'Disabled PM'			=>	'You have disable the messages system',
'Private Messages'		=>	'Messages',
'PM'					=>	'Messages',
'Quick message'			=>	'Send message',
...
'New message'			=>	'You have a message not read!',
'New messages'			=>	'You have %s messages not read!',
'See new'				=>	'See the new message',
'See news'				=>	'See the new messages',
'No new'				=>	'No new message',
'Full boxes'			=>	'Your message boxes are full!',
'Empty boxes'			=>	'Your message boxes are empty.',
'Full to'				=>	'Message boxes full to %s',
'Select'				=>	'Select',
...
'User blocked'			=>	'%s refuses the messages.',
'User disable PM'		=>	'%s disabled the messages.',
...
// profile.php
'use_pm_option'			=>	'Enable messages system',
'email_option_infos'	=>	'With this enabled, an e-mail will be sent for all new message.',
'email_option'			=>	'Message notification by e-mail',
'email_option_full'		=>	'Include message content',
