...
// Load BBCode cache
	if (file_exists(FORUM_CACHE_DIR.'cache_bbcode.php'))
...
{
	global $lang_common, $pun_config, $pun_user, $pun_bbcode;
	...
	foreach($pun_bbcode as $custom_tag) { // Cycle through custom bbcodes and add names to $tags array
