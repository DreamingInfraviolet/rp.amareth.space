...
else if ($action == 'markread')
{
	...
	redirect('forum.php', $lang_misc['Mark read redirect']);
}
...
else if (isset($_GET['email']))
{
	...
	if (isset($_POST['form_sent']))
	{
		...
		// Try to determine if the data in redirect_url is valid (if not, we redirect to forum.php after the email is sent)
		$redirect_url = validate_redirect($_POST['redirect_url'], 'forum.php');
